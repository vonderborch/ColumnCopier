...
// Component        : PostgreSqlProvider.cs
// Author           : Christian
// Created          : 07-14-2017
// 
// Version          : 1.0.0
...
// ***********************************************************************
// <copyright file="PostgreSqlProvider.cs" company="Christian Webber">
//		Copyright ©  2016 - 2017
// </copyright>
// <summary>
...
//
// Changelog: 
//            - 1.0.0 (07-14-2017) - Initial version created.
// ***********************************************************************
using Npgsql;
...
namespace ColumnCopier.Classes.SqlSupport
{
    ...
    public class PostgreSqlProvider : ASqlProvider
    {
        ...
        public override string ExecuteSqlQuery()
        {
            try
            {
                ...
                var cmd = new NpgsqlCommand(this.SqlQuery, conn);
        ...
        private void Connect()
        {
            if (conn == null)
            {
                conn = new NpgsqlConnection(this.SqlConnectionString);
